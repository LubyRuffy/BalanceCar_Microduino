...
#define CHANNEL_STEERING  2 //转向通道
...
#define DIRECTION ROLL

//PID整定参数
#define KP_ANG 0.32    // 0.25
#define KI_ANG 0
#define KD_ANG 40      // 30 28 26  
#define KP_SPD 0.01    //0.08//0.065
#define KI_SPD 0.002   //0.05
#define KD_SPD 0
